...
const Footer = ({ brandName, phone, whatsapp, instagram, location }) => {
  ...
  return (
    // pb-32 IS THE KEY: It extends the background color down behind the sticky bar
    <section id="contact" className="relative pt-24 pb-32 overflow-hidden bg-gradient-to-br from-teal-900 via-blue-950 to-purple-950">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center">
        ...
        <motion.div 
          ...
          className="w-full max-w-lg bg-white/10 backdrop-blur-md border border-yellow-500/30 rounded-2xl p-8 shadow-2xl relative overflow-hidden group mb-12"
        >
          <div className="text-center">
            ...
            <div className="flex flex-col gap-4 mb-8 text-gray-200">
              <div className="flex items-center justify-center gap-3 p-3 rounded-lg bg-black/30 border border-white/5">
                <PhoneIcon sx={{ color: '#FFD700' }} />
                <span className="font-mono text-lg">{phone}</span>
              </div>
              <div className="flex items-center justify-center gap-3 p-3 rounded-lg bg-black/30 border border-white/5">
                <LocationOnIcon sx={{ color: '#FF4444' }} />
        ...
        {/* --- DIVIDER --- */}
        <div className="w-full max-w-4xl h-px bg-gradient-to-r from-transparent via-teal-500/50 to-transparent mb-8"></div>

        {/* --- DEVELOPER SPOTLIGHT (BIG IMAGE) --- */}
        <div className="w-full max-w-4xl flex flex-col md:flex-row items-center justify-between gap-6 bg-black/20 backdrop-blur-sm p-6 rounded-2xl border border-white/5 hover:border-teal-500/30 transition-all duration-300">
          
          <div className="flex items-center gap-6">
            <div className="relative">
              {/* BIG DEVELOPER IMAGE (w-24 h-24 = ~100px) */}
              <img 
                src="/images/developer.jpg" 
                alt="Vraj Sevak" 
                className="w-24 h-24 rounded-full border-4 border-teal-400 object-cover shadow-2xl" 
            ...
            <div className="text-left">
              ...
              <h5 className="text-white text-2xl font-bold leading-none">Vraj Sevak</h5>
          ...
          <div className="flex gap-4">
            {/* LINKEDIN */}
            <a href="https://www.linkedin.com/in/sevak-vraj-79a237258/" target="_blank" rel="noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-[#0077b5] hover:text-white text-gray-300 transition-all duration-300">
            ...
            {/* INSTAGRAM */}
            <a href="https://www.instagram.com/sevak_vraj_007/?igsh=MTFnOHJvZzJlaW4z#" target="_blank" rel="noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-pink-600 hover:text-white text-gray-300 transition-all duration-300">
